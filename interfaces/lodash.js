...
type OPredicate<O, T = any> = ((value: T, key: string, object: O) => ?bool)|$Shape<O>|string;
type OIterateeWithResult<V, O, R> = (GenericMap<V>|(value: V, key: string, object: O) => R)|string;
type OIteratee<O, V = any> = OIterateeWithResult<V, O, any>;

type IteratorFn<T, U> = ((value: T) => U)
                  | ((value: T, index: number) => U)
                  | ((value: T, index: number, array: Array<T>) => U);

type Predicate<T> = $Shape<T> | string | IteratorFn<T, ?bool>;
type Iteratee<T> = IteratorFn<T, mixed> | GenericMap<any> | string;
type Iteratee2<T, U> = ((item: T, index: number, array: ?Array<T>) => U)|$Shape<T>|string;
type FlatMapIteratee<T, U> = ((item: T, index: number, array: ?Array<T>) => Array<U>)|GenericMap<any>|string;
type Comparator<T> = (arr: Array<T>, arr2: Array<T>) => bool;

// Chaining
import Lodash from 'lodash';
declare interface lodashSeq {
  chain<T>(value: T): Lodash;
...
declare module 'lodash' {
  declare class Lodash {
    // Boy wouldn't it be great if this worked?
    // chain<T>(value: T): Function$Prototype$Bind<T, Lodash>;
    (value: any): any;
    chain<T>(value: T): any;
    ...
    orderBy<V, T>(object: T, iteratees?: Array<OIteratee<T>>, orders?: Array<'asc'|'desc'>): Array<V>;
    ...
    findKey<T: Object>(object?: ?T, predicate?: OPredicate<T>): string|void;
    findLastKey<T: Object>(object?: ?T, predicate?: OPredicate<T>): string|void;
    forIn<T: Object>(object?: ?T, iteratee?: OIteratee<T>): Object;
    forInRight<T: Object>(object?: ?T, iteratee?: OIteratee<T>): Object;
    forOwn<T: Object>(object?: ?T, iteratee?: OIteratee<T>): Object;
    forOwnRight<T: Object>(object?: ?T, iteratee?: OIteratee<T>): Object;
    ...
    mapKeys<T: Object>(object?: ?T, iteratee?: OIteratee<T>): Object;
    mapValues<T: Object>(object?: ?T, iteratee?: OIteratee<T>): Object;
    ...
    omit(object?: ?Object, props: Array<string>|string): Object;
    omitBy<O>(object: O, predicate: OPredicate<O>): O; // STRML: This is kind of a lie, it's more like $Shape<O>
    pick(object?: ?Object, ...props: Array<string>): Object;
    pick(object?: ?Object, props: Array<string>|string): Object;
    pickBy<O>(object?: ?O, predicate?: OPredicate<O>): Object;
    ...
    transform<T: Object|Array<any>>(collection: T, iteratee?: OIteratee<T>, accumulator?: any): any;
    ...
    capitalize(string?: void): void; // this is easy to misuse, so I broke the def
    ...
    // Custom functions (STRML)
    // Like merge, but concats arrays - shortcut around mergeWith
    mergeWithArrays(object: Object, ...sources?: Array<?Object>): Object;
    // Removes undefined/null from objects
    trimObject(object: Object): Object;
    // Returns 's' if num !== 1
    pluralize(num: number): string;
    // Like _.result, but supports args to pass to the fns
    resultWithArgs(object?: ?Object, path?: ?Array<string>|string, ...args?: Array<any>): any;
  }
